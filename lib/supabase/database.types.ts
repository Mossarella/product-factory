...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      profiles: {
        Row: { created_at: string; display_name: string | null; id: string; plan: string; readme_footer: string | null; shop_contact: string | null; shop_description: string | null; shop_name: string | null; updated_at: string }
        Insert: { created_at?: string; display_name?: string | null; id: string; plan?: string; readme_footer?: string | null; shop_contact?: string | null; shop_description?: string | null; shop_name?: string | null; updated_at?: string }
        Update: { created_at?: string; display_name?: string | null; id?: string; plan?: string; readme_footer?: string | null; shop_contact?: string | null; shop_description?: string | null; shop_name?: string | null; updated_at?: string }
        Relationships: []
      }
    }
