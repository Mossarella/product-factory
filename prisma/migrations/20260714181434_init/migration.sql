...
CREATE TABLE "Product" (
    ...
    "commercialPrice" DOUBLE PRECISION,
    "folders" TEXT[],
    "etsyTags" TEXT[],
...
CREATE TABLE "MascotFile" (
    ...
    CONSTRAINT "MascotFile_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "MascotFile" ADD CONSTRAINT "MascotFile_productId_fkey" FOREIGN KEY ("productId") REFERENCES "Product"("id") ON DELETE CASCADE ON UPDATE CASCADE;
